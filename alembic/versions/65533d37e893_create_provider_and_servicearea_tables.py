...
Revision ID: 65533d37e893
Revises:
Create Date: 2024-09-26 18:42:31.881776
...
def upgrade() -> None:
    ...
    op.alter_column('providers', 'email',
               existing_type=sa.VARCHAR(),
               nullable=False)
    op.alter_column('service_areas', 'name',
               existing_type=sa.VARCHAR(),
               nullable=False)
    op.alter_column('service_areas', 'price',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               nullable=False)
    op.alter_column('service_areas', 'geojson',
               existing_type=geoalchemy2.types.Geometry(geometry_type='POLYGON', from_text='ST_GeomFromEWKT', name='geometry', _spatial_index_reflected=True),
               nullable=False)
